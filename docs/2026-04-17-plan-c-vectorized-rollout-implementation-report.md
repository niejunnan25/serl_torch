...
- copy 专用 yaml:
  - [examples/libero/configs/train_residual_copy_copy.yaml](/home/hello/codebase/serl_torch/examples/libero/configs/train_residual_copy_copy.yaml:1)
...
- copy 脚本默认入口已切换：
  - LIBERO `copy_copy`: [examples/libero/scripts/run_residual_training_copy_copy.py](/home/hello/codebase/serl_torch/examples/libero/scripts/run_residual_training_copy_copy.py:1400)
...
copy 线现在会把这些 transport 指标带进 summary / timer jsonl：
