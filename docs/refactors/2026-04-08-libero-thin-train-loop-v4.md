...
- Added [actor_support.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_support.py) to introduce a practical actor-side context/state layer:
  - `ActorRuntimeContext`
  - `ActorLoopState`
  - shared helpers for:
    - checkpoint saving
...
- Added [actor_warmup.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_warmup.py) to hold the base-only warmup phase.
- Slimmed [actor_runtime.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_runtime.py) by:
...
- Current line counts after this phase:
  - [actor_runtime.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_runtime.py): `3388`
  - [actor_support.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_support.py): `394`
  - [actor_warmup.py](/vla/users/niejunnan/codebase/serl_torch/serl_launcher/serl_launcher/residual/runtime/actor_warmup.py): `465`
