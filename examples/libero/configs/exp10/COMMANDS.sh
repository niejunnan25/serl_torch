...
# exp10 task8 formal runs launcher
# Usage:
#   bash examples/libero/configs/exp10/COMMANDS.sh <run> <role>
#   bash examples/libero/configs/exp10/COMMANDS.sh <role>   # shorthand for run=null
#
# run:
#   - null
#   - null_utdeff1p
...
PI0_OUT_BASE="${ROOT}/examples/libero/outputs/exp10/chunk/pi0"
PI05_OUT_BASE="${ROOT}/examples/libero/outputs/exp10/chunk/pi05"
...
if [[ -z "${RUN}" || -z "${ROLE}" ]]; then
  echo "Usage: bash examples/libero/configs/exp10/COMMANDS.sh <run> <role>"
  echo "   or: bash examples/libero/configs/exp10/COMMANDS.sh <role>   # defaults to run=null"
