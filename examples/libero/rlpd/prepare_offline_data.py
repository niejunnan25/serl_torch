...
"""Prepare LIBERO direct-action RLPD offline data artifacts."""
...
from serl_torch.examples.libero.rlpd.offline_data import prepare_current_task_offline_data
...
def main(cfg: DictConfig) -> None:
    ...
    logger = logging.getLogger("libero_prepare_rlpd_offline")
    ...
    if offline_inputs.prepared_paths:
        ...
        logger.info(
            "next learner command: python examples/libero/rlpd/run_training.py "
