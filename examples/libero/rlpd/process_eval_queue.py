...
"""Process queued LIBERO RLPD async-eval requests."""
...
from serl_torch.examples.libero.rlpd.eval_runner import run_eval


LOGGER = logging.getLogger("libero_rlpd_async_eval_worker")
...
def _process_one_request(
    *,
    ...
    try:
        ...
        eval_logger = logging.getLogger(f"libero_rlpd_async_eval_worker.eval_{eval_index}")
        summary = run_eval(
            eval_cfg,
