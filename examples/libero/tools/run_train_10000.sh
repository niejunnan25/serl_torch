...
LAUNCH_CMD_RECORD="$(format_cmd bash "$TOOLS_DIR/run_train_10000.sh" "${ORIGINAL_ARGS[@]}")"

echo "=========================================="
echo "  LIBERO run_train_10000.sh"
echo "=========================================="
...
echo "  Port mode   : reuse openpi.port from training config"
echo "=========================================="

export RUN_TRAIN_LAUNCH_CMD="$LAUNCH_CMD_RECORD"
exec bash "$TOOLS_DIR/run_train.sh" "$@"
