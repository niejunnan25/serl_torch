# Code Provenance: ablation_stepchunk_vs_step_task6_alpha_warmup_eval50

## Scope

- Config dir: `examples/libero/conf/ablation_stepchunk_vs_step_task6_alpha_warmup_eval50`
- Output dir: `examples/libero/outputs/libero/ablation_stepchunk_vs_step_task6_alpha_warmup_eval50`
...
- This config directory is currently untracked in git status on the machine (`?? examples/libero/conf/ablation_stepchunk_vs_step_task6_alpha_warmup_eval50/`).
