# Code Provenance: ablation_stepchunk_vs_step_task6_alpha_warmup_utd_sweep

## Scope

- Config dir: `examples/libero/conf/ablation_stepchunk_vs_step_task6_alpha_warmup_utd_sweep`
- Planned output dir: `examples/libero/outputs/libero/ablation_stepchunk_vs_step_task6_alpha_warmup_utd_sweep`
...
- Source templates: `examples/libero/conf/ablation_stepchunk_vs_step_task6_alpha_warmup/*.yaml`
