# Code Provenance: ablation_stepchunk_vs_step_task8_xi_warmup

## Scope

- Config dir: `examples/libero/conf/ablation_stepchunk_vs_step_task8_xi_warmup`
- Output dir: `examples/libero/outputs/libero/ablation_stepchunk_vs_step_task8_xi_warmup`
