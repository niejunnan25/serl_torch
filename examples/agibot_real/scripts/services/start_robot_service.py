...
def _print_help() -> None:
    print("Usage: python scripts/services/start_robot_service.py [-s|-t] [-c CONFIG] [--no-ros]")
    print()
    print("Repo-local wrapper around vendored a2d_sdk.tools.robot_service.")
    print("It bootstraps the vendored AgiBot SDK wheels from examples/agibot_real/vendor/")
    ...
    print("  3. existing examples/agibot_real/robot_service/forwarder")
    print("  4. local cache examples/agibot_real/vendor/a2d_sdk/forwarder_x86_v1.7.0.tar.gz")
    print("Use --no-ros (or AGIBOT_NO_ROS=1 via the shell wrapper) to skip forwarder startup.")
