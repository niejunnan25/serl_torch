...
"""HTTP RPC server for AgiBot real environments."""
...
from serl_torch.examples.agibot_real.env_wrappers.task_env import AgiBotTaskEnv

LOGGER = logging.getLogger("agibot_real_env_server")


class _EnvState:
    def __init__(self) -> None:
        self.env: Optional[AgiBotTaskEnv] = None
...
def main() -> None:
    ...
    LOGGER.info("AgiBot env server started at http://%s:%s", args.host, args.port)
    try:
