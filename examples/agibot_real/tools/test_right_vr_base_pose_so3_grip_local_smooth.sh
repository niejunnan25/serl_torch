...
echo "[agibot-vr-right] SO3 grip-local smooth standalone test"
echo "[agibot-vr-right] ROTATION_CALIBRATION=${ROTATION_CALIBRATION}"
echo "[agibot-vr-right] GRIP_LOCAL_ROT_MAP=${GRIP_LOCAL_ROT_MAP}"
echo "[agibot-vr-right] HZ=${HZ} TRAJECTORY_TIME=${TRAJECTORY_TIME}"
echo "[agibot-vr-right] MAX_STEP=${MAX_STEP} SMOOTHING=${SMOOTHING} COMMAND_DEADBAND=${COMMAND_DEADBAND}"
echo "[agibot-vr-right] MAX_ROT_STEP_DEG=${MAX_ROT_STEP_DEG} ROT_SMOOTHING=${ROT_SMOOTHING} ROTATION_DEADBAND_DEG=${ROTATION_DEADBAND_DEG}"
