...
def main():
    ...
    if args.reinstall:
        reader.install(APK_path='/home/xiongslab/MMP/oculus_reader/oculus_reader/APK/teleop-debug.apk',reinstall=True)
        # reader.install(APK_path='/home/ubuntu/Downloads/TactAR.apk',reinstall=True)
    elif args.uninstall:
        reader.uninstall()
    else:
        reader.install()
